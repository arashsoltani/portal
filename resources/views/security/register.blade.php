            ...
            <div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35">
                ...
                <div class="d-flex flex-column-fluid flex-column flex-center">
                    ...
                    <div class="login-form login-signin py-11">
                        ...
                        <!--begin::Form-->
                            <form class="form" method="POST" action="{{url('/register')}}" novalidate="novalidate" id="kt_login_signup_form">
                                <!--begin::Title-->
                                @csrf
                                @method('POST')
                                ...
                                <div class="form-group">
                                    <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" type="text" placeholder="نام" name="first_name" autocomplete="off"/>
                                </div>
